<div class="home-page">
    <div class="container">
        <div class="flex full-home-banners">  
            <div class=" full-home-banners__slide">
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="d-block w-100" src="img/slider/3.png" alt="First slide" />
                        </div>
            ...
            <div class=" full-home-banners__right-wrapper">
                <div class="full-home-banners__right-banner">
                    <div class="full-home-banners__right-banner-img">
